...
export default function Home(){
 ...
 const sendWhatsApp=(e:React.FormEvent)=>{e.preventDefault();const text=`Hi Roy, I want to start a project.%0A%0AName: ${form.name}%0ABusiness: ${form.business}%0AWebsite type: ${form.type}%0ABudget: ${form.budget}%0ADetails: ${form.message}`;window.open("https://wa.me/918124262289?text="+text,"_blank")};
 return <main>
