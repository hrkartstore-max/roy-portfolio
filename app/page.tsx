...
Details: ${form.message}`);window.open("https://wa.me/918124262289?text="+text,"_blank");setSubmitted(true)};
 return <main>
  ...
  <section id="what-you-get" className="section shell what-you-get">
